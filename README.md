# Sniper Elite Resistance Trainer — SP Project

**A single-player trainer project for Sniper Elite Resistance, the Game Pass headliner players are pre-loading.**
...
The game is trending via the PS Plus leak and Game Pass lineup — trainer searches follow within days of such spikes.

## Design goals

| Area | Design goal |
|---|---|
| **Approach** | Campaign-convenience toggle design |
| **Principle** | Stealth-friendly hotkeys (no alt-tab) |
| **Detail** | No invasion-mode support, hard line |
| **Focus** | Lightweight footprint goal |
| **Goal** | Roadmap shaped by issue votes |
